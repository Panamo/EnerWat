...
(function ($, window, undefined) {
    $.extend($.easing, {
        def: 'out', out: function (none, currentTime, startValue, endValue, totalTime) {
    ...
    var rhinoSlider = function (element, opts) {
        ...
        var
            setUpSettings = function (settings) {
                ...
                $slider.css({top: 'auto', left: 'auto', position: 'relative'});
                vars.items.css({
                    margin: 0,
                ...
                vars.active.css({zIndex: 1, opacity: 1});
                if (!settings.cycled) {
                    vars.items.each(function () {
                        var $item = $(this);
    ...
    $.fn.rhinoslider.effects = {
        slide: function ($slider, params, callback) {
            ...
            if (settings.animateActive) {
                vars.active.css({top: 0, left: 0}).animate({
                    top: values.top,
                    left: values.left,
                    opacity: 1
                }, settings.effectTime, values.easing);
            }
            vars.next.css({top: values.nextTop, left: values.nextLeft}).animate({
                top: 0,
                left: 0,
                opacity: 1
